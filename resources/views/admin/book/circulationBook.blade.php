...
@section('content')
    ...
    <h1 class="text-center text-success">Add Book</h1>
    <hr/>

    <div class="row">
        <div class="well">
            <form class="form-horizontal" action="{{ route('new-book') }}" method="POST">

                {{ csrf_field() }}

                <input type="hidden" value="Book" name="log_section">
                <input type="hidden" value="Add" name="log_action">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="edition_year" class="form-control " id="edition_year"
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="add_date" class="form-control" id="datetimepicker4"
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-info">Save Book Info</button>
                                        </div>
                                    </div>
